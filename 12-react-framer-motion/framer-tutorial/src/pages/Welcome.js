...
export default function WelcomePage() {
  ...
  // the parameters are, first parameter is the value you want to transform, second parameter is the range of the value, and the third parameter is the range of the output value
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          style={{ opacity: opacityCity, y: yCity }} // style here belong to framer motions
          src={cityImg}
