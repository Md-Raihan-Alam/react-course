  ...
  const {
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ["events"],
        refetchType: "none",
      }); // refetchType: "none" is used to prevent the query from refetching after the mutation is successful
      navigate("/events");
    },
  });
    ...
    <>
      {isDeleting && (
        <Modal onClose={handleStopDelete}>
          <h2>Are you sure?</h2>
          <p>
            Do you realy wan to delete this event? This action cannot be undone.
          </p>
